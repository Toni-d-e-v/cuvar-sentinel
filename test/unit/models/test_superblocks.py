...
def go_list_proposals():
    items = [
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "test": "dean-miller-5493", "payment_address": "RQfn923bBm7dgZZTY9fm1mV7a7AwbJnVCw", "payment_amount": 1, "start_epoch": 1474261086, "type": 1, "url": "http://gov.crypto.ba"}]]',
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "toni": "fernandez-7625", "payment_address": "RVKKfbR8tTRZee6kYEnQ9LC886L1FXXTq", "payment_amount": 5000, "start_epoch": 1474261086, "type": 1, "url": "http://gov.crypto.ba"}]]',
